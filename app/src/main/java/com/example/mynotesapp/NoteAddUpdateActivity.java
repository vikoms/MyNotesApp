...
public class NoteAddUpdateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void showAlertDialog(int type) {
        ...
        if (isDialogClose) {
            dialogTitle = "Batal";
            dialogMessage = "Apakah anda ingin membatalkan perubahan di form?";
        } else {
            dialogTitle = "Hapus Note";
            dialogMessage = "Apakah anda yakin ingin mengahapus item ini ? ";
        }
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (isDialogClose) {
                            ...
                            if (result > 0) {
                                ...
                                Toast.makeText(NoteAddUpdateActivity.this, "Gagal Mengahapus data", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_submit) {
            ...
            if (TextUtils.isEmpty(title)) {
                edtTitle.setError("Field can not be black");
                return;
            }
